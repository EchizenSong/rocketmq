...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     *
     * 消费者组概念，根据它实现负载均衡
     * 注意：消费者组中的消费者实例必须具有完全相同的topic订阅
     */
     ...
     * </li>
     * </ul>
     * CONSUME_FROM_LAST_OFFSET--默认从最大偏移量开始消费
     ...
     * 并发消费前会有流控，判断处理队列process queue中最大和最小偏移量的差值，不能大于2000
     */
    ...
    public DefaultMQPushConsumer(final String consumerGroup) {
        // 默认AllocateMessageQueueAveragely负载均衡策略，平均分配
